...
export default function ProfilePage() {
  ...
  return (
    <View style={profileStyles.container}>
      ...
      {/* circles */}
      <Svg width="33" height="33" viewBox="0 0 33 33" fill="none" style={profileStyles.circle1}>
        <Circle cx={6} cy={6} r={6} fill="#F6E54B"/>
      </Svg>
      <Svg width="33" height="33" viewBox="0 0 33 33" fill="none" style={profileStyles.circle2}>
